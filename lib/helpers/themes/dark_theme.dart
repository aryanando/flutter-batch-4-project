...
import 'package:flutter_batch_4_project/consts/colors.dart';
...
ThemeData darkTheme(context) => ThemeData(
    ...
    dividerTheme: Theme.of(context)
        .dividerTheme
        .copyWith(color: AppColor.dividerDark, thickness: 1, space: 1),
    ...
    searchViewTheme: Theme.of(context).searchViewTheme.copyWith(
          dividerColor: AppColor.dividerDark,
          headerHintStyle: TextStyle(color: AppColor.placeholderDark),
          headerTextStyle: TextStyle(color: AppColor.primaryDark),
        ),
    iconButtonTheme: IconButtonThemeData(
        style: Theme.of(context).iconButtonTheme.style?.copyWith(
            iconColor: WidgetStatePropertyAll(AppColor.primaryDark))),
    iconTheme:
        Theme.of(context).iconTheme.copyWith(color: AppColor.primaryDark),
    searchBarTheme: Theme.of(context).searchBarTheme.copyWith(
          ...
          surfaceTintColor:
              WidgetStatePropertyAll(AppColor.inputBackgroundDark),
          ...
          hintStyle: WidgetStateTextStyle.resolveWith((state) {
            return TextStyle(color: AppColor.placeholderDark);
          }),
          textStyle: WidgetStateTextStyle.resolveWith((state) {
            return TextStyle(color: AppColor.primaryDark);
          }),
        ),
