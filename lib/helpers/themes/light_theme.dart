...
ThemeData lightTheme(context) => ThemeData(
    ...
    dividerTheme: Theme.of(context)
        .dividerTheme
        .copyWith(color: AppColor.dividerLight, thickness: 1, space: 1),
    ...
    listTileTheme: Theme.of(context).listTileTheme.copyWith(
          ...
          subtitleTextStyle: TextStyle(
              fontSize: 14, height: 1.5, color: AppColor.placeholderLight),
        ),
    ...
    iconTheme:
        Theme.of(context).iconTheme.copyWith(color: AppColor.primaryLight),
    searchBarTheme: Theme.of(context).searchBarTheme.copyWith(
          backgroundColor:
              WidgetStatePropertyAll(AppColor.inputBackgroundLight),
          surfaceTintColor:
              WidgetStatePropertyAll(AppColor.inputBackgroundLight),
          ...
          hintStyle: WidgetStateTextStyle.resolveWith((state) {
            return TextStyle(color: AppColor.placeholderLight);
          }),
          textStyle: WidgetStateTextStyle.resolveWith((state) {
            return TextStyle(color: AppColor.primaryLight);
          }),
        ),
